...
<script>
$(function(){
	$(".existenceDetailTr").click(function(){
		location.href = "existenceDetail.do?no="+$(this).attr("id")+"&id="+$(".userid").val();
	});
})
</script>
<body>
	<div class="container">
		<div class="container-fluid">
			...
			<div class="row rowDiv">
				<div class="col-md-12">
					<h3><label><big class="marked"><strong>자</strong></big>작곡</label></h3>
					<hr>
					<c:if test="${user ne null}">
						<div align="right">
							<a href="existenceEdit.do" role="button" class="btn btn-primary">글쓰기</a>
						</div>
					</c:if>
						...
						<table class="table table-hover">
							...
							<tbody>
								<c:forEach var="i" items="${list}">
									<tr class="existenceDetailTr" id="${i.no}">
