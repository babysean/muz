		...
		<div class="container-fluid">
			...
			<div class="row rowDiv">
				<div class="col-md-12">
					...
					<hr>
					<form action="existenceEditProcess.do" method="post">
						<div class="col-md-12">
							...
							<div class="form-group col-md-6">
								<label class="col-sm-2 control-label">작성시간</label>
								<div class="col-sm-10">
						...
						<div class="col-md-12">
							<div class="col-md-12" align="right">
								...
								<a href="existence.do?pages=1" role="button" class="btn btn-danger">뒤로가기</a>
							</div>
						</div>
					</form>
				</div>
